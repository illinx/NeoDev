...
{		
	...
	write_sprite_data(x, y, xz, yz, 2, 1, (const PTILEMAP)&sprite2[0]);
//x, y, xz, yz, vert, horiz
	change_sprite_pos(3, 100, 100, 2);
//spr#, x, y, vert
	//==============

	//==============
	set_current_sprite(4);
	write_sprite_data(x, y, xz, yz, 2, 1, (const PTILEMAP)&sprite2[1]);
//x, y, xz, yz, vert, horiz
	change_sprite_pos(4, 150, 150, 2);
//spr#, x, y, vert
	//==============
...
while(1){}
	...
	write_sprite_data(x, y, xz, yz, clip, 32, (const PTILEMAP)&mysprite);
	//write_sprite_data(x, y, xz, yz, 3, 3, (const PTILEMAP)&mysprite);
